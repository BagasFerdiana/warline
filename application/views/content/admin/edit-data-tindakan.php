                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" role="form" method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Kode Tindakan</label>
                                      <div class="col-lg-10">
                                          <input type="text" autofocus class="form-control" id="inputEmail1" placeholder="" name="kode" value="<?php echo $value->kode; ?>" required>
                                      </div>
                                  </div>

                                  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Nama Tindakan</label>
                                      <div class="col-lg-10">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="number" autofocus class="form-control" id="inputEmail1" placeholder="" name="harga" value="<?php echo $value->harga; ?>" required>
                                      </div>
                                  </div>
