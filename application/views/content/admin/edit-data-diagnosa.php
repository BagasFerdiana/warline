                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" role="form" method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Kode Diagnosa</label>
                                      <div class="col-lg-10">
                                  ...
                                  <div class="form-group">
                                      <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Nama Diagnosa</label>
                                      <div class="col-lg-10">
