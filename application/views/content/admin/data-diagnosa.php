                                ...
                                <div class="table-responsive">
                                    <table  class="display table table-bordered table-striped" id="example">
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                            <a href="<?php echo $url_edit.'/'.$row->id_data_diagnosa; ?>" title="Edit" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i></a>
                                            <a href="<?php echo $url_delete.'/'.$row->id_data_diagnosa; ?>" onclick="return confirm('Apakah anda yakin?')" title="Hapus" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></a>
                                          </td>
                                      </tr>
                                      <?php 
                                      $no++;
