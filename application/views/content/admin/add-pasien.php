                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" role="form" method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" autofocus class="form-control" id="inputEmail1" placeholder="" name="no_rm" required>
                                      </div>
                                  </div>  
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" id="inputEmail1" placeholder="" name="nama">
                                      </div>
                                  </div>  
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control default-date-picker" id="inputEmail1" placeholder="" value="03-21-1996" name="tgl_lahir" >
                                      </div>
                                  </div>  
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" class="form-control" id="inputEmail1" placeholder="" name="no_telp">
                                      </div>
                                  </div> 
