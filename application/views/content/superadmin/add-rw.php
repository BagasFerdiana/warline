                          ...
                          <div class="panel-body">
                              <form class="form-horizontal" role="form" method="POST" action="<?php echo $action; ?>" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" autofocus class="form-control" id="inputEmail1" placeholder="" name="daerah" required>
                                      </div>
                                  </div>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-10">
                                          <input type="text" autofocus class="form-control" id="inputEmail1" placeholder="" name="kode_pos" required>
                                      </div>
                                  </div>
