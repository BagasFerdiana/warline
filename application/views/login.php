...
<head>
    ...
    <link href="<?php echo base_url() . '_include/css/login.css'; ?>" rel="stylesheet" />
...
<body class="lock-screen">
    ...
    <div class="lock-wrapper">
        <form class="form-signin" action="<?php echo base_url('login/action'); ?>" method="post">
            <h1>LOGIN <?php echo strtoupper('WARLINE'); ?></h1>
            <div class="lock-box">
                <div class="row">
                    <div class="panel-body">
                            ...
                            <div class="form-group close-alert">
                                <div class="col-xs-12">
                                    <div class="alert alert-danger">
                                        <i class="fa fa-info-circle"></i> <?php echo $this->session->flashdata('gagal'); ?>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <div class="form-group">
                            <div class="col-xs-12">
                                <input class="form-control" autofocus type="text" required="" placeholder="Username" name="username">
                            </div>
                        </div>
                        ...
                        <div class="form-group text-center m-t-40">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-block btn-lg waves-effect waves-light tombol" type="submit">Log In</button>
                            </div>
                        </div>
                    </div>
                </div>
